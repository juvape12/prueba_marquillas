...
<footer class="text-center text-white footer" style="padding-top:2rem;">
            ...
            <div class="row text-center d-flex justify-content-center p-0">
                ...
                <div class="col-md-2 col-md-offset-2">
                    <h6 class="text-uppercase font-weight-bold">
                        <a href="#" class="text-white fw-bold" style="text-decoration: none;">About us</a>
                    </h6>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-2">
                    <h6 class="text-uppercase font-weight-bold">
                        <a href="#" class="text-white fw-bold" style="text-decoration: none;">Services</a>
                    </h6>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-2">
                    <h6 class="text-uppercase font-weight-bold">
                        <a href="mailto:victor.grajales@marquillas.com.co" class="text-white" target="_blank" style="text-decoration: none;">Contact</a>
                    </h6>
                </div>
                <!-- Grid column -->
            </div>
    ...
    <div class="text-center p-2 copy-footer">
        <p class="d-flex justify-content-center align-items-center">
            All Rights Reserved ©
            <a class="text-white" href="#" style="text-decoration: none;">Marquilas</a> {{date('Y')}}
        </p>
    </div>
    <!-- Copyright -->
</footer>
